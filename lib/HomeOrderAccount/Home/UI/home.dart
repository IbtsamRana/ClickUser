    ...
    if (permission == LocationPermission.whileInUse ||
      ...
      if (isLocationServiceEnableds) {
        ...
        await Geocoder.local
          ...
          if (value[0].locality != null && value[0].locality.isNotEmpty && value[0].subLocality!=null) {
            setState(() {
              this.lat = lat;
              this.lng = lng;
    ...
    await Geocoder.local
        ...
        .then((value) {
          for (int i = 0; i < value.length; i++) {
            print('${value[i].addressLine.toString()}');
            if (value[i].locality != null && value[i].locality.length > 1) {
              if (value[i].locality != null && value[i].locality.isNotEmpty && value[i].subLocality!=null) {
                setState(() {
                  this.lat = lat;
                  this.lng = lng;
                  String city = '${value[i].locality}';
                  cityName = '${city.toUpperCase()} (${value[i].subLocality})';
                });
              } else if (value[i].subAdminArea != null &&
                  value[i].subAdminArea.isNotEmpty) {
                this.lat = lat;
                this.lng = lng;
                String city = '${value[i].subAdminArea}';
                cityName = '${city.toUpperCase()}';
              }else{
                setState(() {
                  this.lat = lat;

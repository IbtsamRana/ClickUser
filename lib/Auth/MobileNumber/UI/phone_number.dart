              ...
              child: Column(
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      Container(
                        width: (widthRender>500)?widthRender/2:widthRender,
                        child: Image.asset(
                  ...
                  Expanded(
                    child: Center(
                      heightFactor: 200,
                      widthFactor: (widthRender>500)?widthRender/2:widthRender,
                      child: Image.asset(
                        "images/logos/Delivery.gif",
                        height: 200,
                        width: (widthRender>500)?widthRender/2:widthRender, //footer image
                      ),
                    ),
                  ),
                  // Expanded(
                          ...
                          onPressed: () {
                            if (!showDialogBox) {
                              ...
                              if (_controller.text.length < numberLimit) {
                                ...
                                Toast.show(
                                    locale.validmobilenumber, context,

class DealProductList {
  ...
  factory DealProductList.fromJson(dynamic json){
    return DealProductList(json['stock'], json['price'], json['deal_price'],json['varient_image'], json['quantity'], json['unit'], json['description'], json['product_name'], json['product_image'], json['varient_id'], json['product_id'], json['valid_to'], json['valid_from'], json['timediff'], json['hoursmin'],0);
  }

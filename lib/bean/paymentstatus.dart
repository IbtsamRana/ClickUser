...
//   dynamic status;
//   dynamic payment_key;
//   dynamic payment_secrect_key;
//   dynamic payment_mode;
//   dynamic merchant_id;
//
//   PaymentVia(this.payment_id, this.vendor_id, this.status, this.payment_key, this.payment_secrect_key, this.payment_mode, this.merchant_id);
//
//   factory PaymentVia.fromJson(dynamic json){
//     return PaymentVia(json['payment_id'], json['vendor_id'], json['status'], json['payment_key'], json['payment_secrect_key'], json['payment_mode'], json['merchant_id']);
//   }
//
//   @override
//   String toString() {
//     return 'PaymentVia{payment_id: $payment_id, vendor_id: $vendor_id, status: $status, payment_key: $payment_key, payment_secrect_key: $payment_secrect_key, payment_mode: $payment_mode, merchant_id: $merchant_id}';
//   }
// }
//
...
//   dynamic merchant_id;
//
//   PaymentViaParcel(this.paymentvia_id, this.status, this.payment_key, this.payment_secrect_key, this.payment_mode, this.merchant_id);
//
//   factory PaymentViaParcel.fromJson(dynamic json){
//     return PaymentViaParcel(json['paymentvia_id'], json['status'], json['payment_key'], json['payment_secrect_key'], json['payment_mode'], json['merchant_id']);
//   }
//
//   @override
//   String toString() {
//     return 'PaymentViaParcel{paymentvia_id: $paymentvia_id, status: $status, payment_key: $payment_key, payment_secrect_key: $payment_secrect_key, payment_mode: $payment_mode, merchant_id: $merchant_id}';
//   }
// }

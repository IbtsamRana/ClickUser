...
class PaymentPageState extends State<PaymentPage> {
  ...
  void initState() {
    ...
    StripePayment.setOptions(StripeOptions(
        publishableKey:
            "pk_test_51HzzheJi3WFPjQpEVSPqOTgVcICnxl9BnVPj9o2xp0ZJxNeHTz0hVNYrG5NPFvx44H6B6ihZcKd76hkT2KEHmnsG00N6i68gQz",
        merchantId: "Test",
        androidPayMode: 'test'));
...
var payPlugin = PaystackPlugin();
  ...
  void setStripePayment(dynamic clientScretKey, double amount,
      CreditCard creditCardPay, String paymentCurrency, BuildContext context) {

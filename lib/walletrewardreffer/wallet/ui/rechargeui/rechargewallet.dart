...
class RechargeWalletState extends State<RechargeWallet> {
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 5,),
                              Text(
                                'Amount to be paid ${currency} ${totalAmount}',
                                style: Theme.of(context)
                                    .textTheme
                                    .caption
                                    .copyWith(
                        ...
                        if('${paymentVia.paystack.paystackStatus}'.toUpperCase()=='YES'){
                          ...
                          Navigator.of(context).pushNamed(PageRoutes.stripecard).then((value){
                            if(value!=null){
                              ...
                              setStripePayment(paymentVia.stripe.stripeSecret,totalAmount,cardPay,paymentVia.stripe.paymentCurrency);
                            }else{
                            ...
                            child: Container(
                              ...
                              child: BuildListTile(
                                ...
                                onTap: () {
                                  ...
                                  openCheckout('${paymentVia.razorpay.razorpayKey}', (totalAmount * 100),'${paymentVia.razorpay.razorpaySecret}');
                                },
                              ),
                            )),
                        Visibility(
                                ...
                                onTap: () {
                                  ...
                                  Navigator.of(context).push(MaterialPageRoute(builder: (context){
                                    return PaypalPayment(apCurrency:'${paymentVia.paypal.paymentCurrency}',clientId:'${paymentVia.paypal.paypalClientId}',secret:'${paymentVia.paypal.paypalSecret}',amount: '$totalAmount',onFinish:(id,status){
                                      print('$id $status');
                                      if(status=='success'){
                                        placedOrder("success", "Card",totalAmount);
                                      }else{
                                        setState(() {
                                          showDialogBox = false;
                                        });
  ...
  void placedOrder(paymentStatus, paymentMethod, amount) async {
    var locale = AppLocalizations.of(context);
  ...
  void setStripePayment(dynamic clientScretKey, double amount, CreditCard creditCardPay, String paymentCurrency) {
    ...
    StripePayment.createPaymentMethod(PaymentMethodRequest(
      ...
      createPaymentIntent('${amount.toInt()*100}','$paymentCurrency',headers,value,clientScretKey);
    }).catchError((e){

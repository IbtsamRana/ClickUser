...
class PaymentRestPageState extends State<PaymentRestPage> {
 ...
 PaymentVia paymentVia;
                        ...
                        onTap: () {
                          if('${paymentVia.paystack.paystackStatus}'.toUpperCase()=='YES'){
                            ...
                            StripePayment.setOptions(
                                StripeOptions(
                                  publishableKey:'${paymentVia.stripe.stripePublishable}',
                                  merchantId: '${paymentVia.stripe.stripeMerchantId}',
                                  androidPayMode: 'test',
                                ));
                                        ...
                                        onTap: () {
                                          setState(() {
                                            if (totalAmount != 0.0) {
                                              ...
                                              Toast.show(
                                                  locale.couponCodeNotApplicable,
                                                  context,
                                                  duration:
                                                  Toast.LENGTH_SHORT,
                                                ...
                                                onChanged: (val) {
                                                  ...
                                                  if (radioId != t ||
                                                    ...
                                                    setState(() {
                                                      ...
                                                      showDialogBox =
                                                      true;
                                                      appCoupon(couponL[t].coupon_code,context);
                                                    });
                                                  }
                                                })
                                          ],
  ...
  void createOrderId(dynamic clientid, dynamic secretKey, dynamic amount, dynamic currency, dynamic receiptId, Razorpay razorpay, BuildContext context) async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  void setStripePayment(dynamic clientScretKey, double amount, CreditCard creditCardPay, String paymentCurrency, BuildContext context) {
    ...
    StripePayment.createPaymentMethod(PaymentMethodRequest(
      ...
      createPaymentIntent('${amount.toInt()*100}','$paymentCurrency',headers,value,clientScretKey,context);
    }).catchError((e){
  ...
  void createPaymentIntent(String amount, String currency,Map<String, String> hearder, PaymentMethod paymentMethod, clientScretKey, BuildContext context) async {
    try {
    ...
    var bodyd = {
      "data": {
        ...
        "attributes": {
          ...
          "currency": "PHP",
          "redirect": {
            "failed": "http://maplesak.com/asap_ph/payment_failed.html",
            "success": "http://maplesak.com/asap_ph/payment_success.html"
          },
          "type": type
        }
      }

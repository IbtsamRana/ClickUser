      ...
      children: <Widget>[
        ...
        ListView.separated(
          itemBuilder: (context, index) {
            ...
            return (widget.categoryListNew[index].variant!=null && widget.categoryListNew[index].variant.length>0)?Row(
                                  ...
                                  db
                                    ...
                                    db
                                      ...
                                      productDescriptionModalBottomSheets(
                                          ...
                                          widget.categoryListNew[index].variant.indexOf(widget.categoryListNew[index].variant[0]),
                                          addOnlist,
